    ...
    <div className="relative h-screen w-full overflow-hidden text-white">
      ...
      <motion.div
        ...
        style={{
          ...
          width: "100%",
          height: "100%",
          backgroundImage: "url(https://images.unsplash.com/photo-1579193219623-8ef5f1baa518?q=80&w=1600&auto=format&fit=crop)",
      ...
      <div className="relative z-10 h-full flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-3xl mb-6 font-semibold">Register</h2>
          ...
          <motion.button
            ...
            className="w-full bg-green-600 py-3 rounded-xl shadow-lg"
          >
            Register
          </motion.button>
